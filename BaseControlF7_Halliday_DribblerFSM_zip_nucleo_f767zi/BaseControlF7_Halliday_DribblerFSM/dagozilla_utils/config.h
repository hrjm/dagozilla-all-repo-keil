...
// PID Constants
const double KP_R = 1.0;    //Kp for right Locomotion motor
const double KI_R = 1.5;    //Ki for right Locomotion motor
...
const double KP_B = 1.0;    //Kp for back Locomotion motor
const double KI_B = 1.5;    //Ki for back Locomotion motor
...
const double KP_L = 1.0;    //Kp for left Locomotion motor
const double KI_L = 1.5;    //Ki for left Locomotion motor
...
const double FF_DL = 0.0;    //Feedforward gain for left dribbler motor
...
const double FF_DR = 0.0;    //Feedforward gain for right dribbler motor
