#ifndef _ROS_dagozilla_msgs_StringListMsg_h
#define _ROS_dagozilla_msgs_StringListMsg_h
...
namespace dagozilla_msgs
{
  ...
  class StringListMsg : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "dagozilla_msgs/StringListMsg"; };
