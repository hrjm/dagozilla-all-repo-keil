...
void mainProcess(){
    ...
    while(1){
    locomotion_R_target_rate = 0.5;
    locomotion_L_target_rate = 0.5;
    locomotion_B_target_rate = 0.5;
    dribbler_L_target_rate = 0.5;
    dribbler_R_target_rate = 0.5;
...
//        }
        Thread::wait(20);
        pc.printf("vL : %.2f\t vB : %.2f\t vR : %.2f\t extL : %.2f\t extB : %.2f\t extR : %.2f\n", rotInL, rotInB, rotInR, cur_locomotion_L, cur_locomotion_B,cur_locomotion_R);
    }
}
...
void moveLocomotion(){
    locomotionMotorL.setpwm(0.5);
    locomotionMotorR.setpwm(0.5);
    locomotionMotorB.setpwm(0.5);
