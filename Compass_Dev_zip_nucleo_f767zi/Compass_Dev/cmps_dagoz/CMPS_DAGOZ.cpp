...
void CMPS_DAGOZ::saveCalibrationProfile(void){
    char registerNumber[3] = {STORE_CALIBRATION_PROFILE_1, STORE_CALIBRATION_PROFILE_2, STORE_CALIBRATION_PROFILE_3};
    
    i2c->write(i2cAddress, &registerNumber[0], 1);
    wait_ms(20);
    
    i2c->write(i2cAddress, &registerNumber[1], 1);
    wait_ms(20);
    
    i2c->write(i2cAddress, &registerNumber[2], 1);

}

void CMPS_DAGOZ::eraseCalibrationProfile(void){
    char registerNumber[3] = {ERASE_CALIBRATION_PROFILE_1, ERASE_CALIBRATION_PROFILE_2, ERASE_CALIBRATION_PROFILE_3};
