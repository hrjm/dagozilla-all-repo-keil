...
#define STORE_CALIBRATION_PROFILE_1 0xF0
#define STORE_CALIBRATION_PROFILE_2 0xF6
#define STORE_CALIBRATION_PROFILE_3 0xF5
#define ERASE_CALIBRATION_PROFILE_1 0xE0
#define ERASE_CALIBRATION_PROFILE_2 0xE5
#define ERASE_CALIBRATION_PROFILE_3 0xE2
...
public:
    ...
    void saveCalibrationProfile(void);

    void eraseCalibrationProfile(void);
