...
namespace dgz_msgs
{
  ...
  class HardwareCommand : public ros::Msg
  {
    public:
      ...
      typedef bool _base_active_type;
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 0) = (u_is_shoot.base >> (8 * 0)) & 0xFF;
      ...
      u_base_active.real = this->base_active;
      *(outbuffer + offset + 0) = (u_base_active.base >> (8 * 0)) & 0xFF;
      offset += sizeof(this->base_active);
      return offset;
    }
    ...
    virtual int deserialize(unsigned char *inbuffer) 
    {
      ...
      u_base_active.base = 0;
      u_base_active.base |= ((uint8_t) (*(inbuffer + offset + 0))) << (8 * 0);
      this->base_active = u_base_active.real;
      offset += sizeof(this->base_active);
     return offset;
    }

    virtual const char * getType()  { return "dgz_msgs/HardwareCommand"; };
    virtual const char * getMD5()  { return "d0122b2885b0def8602f3794e4783e63"; };
